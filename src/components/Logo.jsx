...
export function LogoMark({ size = 40 }) {
  ...
  return (
    <svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: r, display: 'block', flexShrink: 0 }}>
      ...
      {/* Sunrise rays */}
      <line x1="256" y1="330" x2="66"  y2="200" stroke="#ffa600" strokeWidth="10" strokeLinecap="round" opacity="0.20" filter={`url(#md-rg-${s})`}/>
      ...
      <line x1="256" y1="330" x2="392" y2="142" stroke="#ffa600" strokeWidth="12" strokeLinecap="round" opacity="0.45" filter={`url(#md-rg-${s})`}/>
      <line x1="256" y1="330" x2="176" y2="108" stroke="#f8ae00" strokeWidth="14" strokeLinecap="round" opacity="0.70" filter={`url(#md-rg-${s})`}/>
      <line x1="256" y1="330" x2="336" y2="108" stroke="#ffb300" strokeWidth="14" strokeLinecap="round" opacity="0.70" filter={`url(#md-rg-${s})`}/>
      <line x1="256" y1="330" x2="256" y2="88"  stroke="#dfa300" strokeWidth="17" strokeLinecap="round" opacity="0.90" filter={`url(#md-rg-${s})`}/>

      {/* Sun glow rings */}
      <circle cx="256" cy="128" r="58" fill="#ffa600" opacity="0.15" filter={`url(#md-glw-${s})`}/>
      <circle cx="256" cy="128" r="42" fill="#fdb100" opacity="0.25"/>
...
export function LogoFull({ size = 36, variant = 'light', noTagline = false }) {
  ...
  const textSub    = variant === 'dark' ? '#fc4300' : variant === 'gold' ? '#FFE08A' : 'rgba(255,255,255,0.95)';
  const textMorning= variant === 'dark' ? '#f04000' : variant === 'gold' ? '#fca400' : '#f55e00';
